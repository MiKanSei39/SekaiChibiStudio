...
var spine = (() => {
  ...
  window.__spine_bundle_progress = '0';
  ...
  window.__spine_bundle_progress = '1';
  ...
  window.__spine_bundle_progress = '2';
  ...
  window.__spine_bundle_progress = '3';
  ...
  window.__spine_bundle_progress = '4';
  ...
  window.__spine_bundle_progress = '5';
  ...
  window.__spine_bundle_progress = '6';
  ...
  var _SlotMesh = class extends import_mesh.Mesh {
    name = "";
    warnedTwoTint = false;
    constructor() {
  ...
  var SlotMesh = _SlotMesh;
  __publicField(SlotMesh, "auxColor", [0, 0, 0, 0]);

  window.__spine_bundle_progress = '7';
  ...
  var _Spine = class extends import_display.Container {
    skeleton;
    state;
    _debug = void 0;
    get debug() {
  ...
  var Spine = _Spine;
  __publicField(Spine, "vectorAux", new Vector2());
  __publicField(Spine, "clipper", new SkeletonClipping());
  __publicField(Spine, "QUAD_TRIANGLES", [0, 1, 2, 2, 3, 0]);
  __publicField(Spine, "VERTEX_SIZE", 2 + 2 + 4);
  __publicField(Spine, "DARK_VERTEX_SIZE", 2 + 2 + 4 + 4);
  __publicField(Spine, "skeletonCache", /* @__PURE__ */ Object.create(null));
  Skeleton.yDown = true;
...
`;
  ...
  var _DarkSlotMesh = class extends DarkTintMesh {
    name = "";
    constructor() {
      super();
    }
  ...
  var DarkSlotMesh = _DarkSlotMesh;
  __publicField(DarkSlotMesh, "auxColor", [0, 0, 0, 0]);

  window.__spine_bundle_progress = '8';
...
`;
  ...
  __publicField(DarkTintRenderer, "extension", {
    name: "darkTintBatch",
